...
:- modeh(1, great(+group,+group)).

:- modeb(1,x_subst(+group,-position,-group)).
:- modeb(1,alk_groups(+group,-number)).
:- modeb(1,alk_groups(+group,#number)).
:- modeb(1,r_subst_1(+group,-group)).
:- modeb(1,r_subst_2(+group,-group)).
:- modeb(1,r_subst_3(+group,-group)).
:- modeb(1,ring_substitutions(+group,-number)).
:- modeb(1,ring_substitutions(+group,#number)).
:- modeb(1,ring_subst_1(+group,-group)).
:- modeb(1,ring_subst_2(+group,-group)).
:- modeb(1,ring_subst_3(+group,-group)).
:- modeb(1,ring_subst_4(+group,-group)).
:- modeb(1,ring_subst_5(+grioup,-group)).
:- modeb(1,ring_subst_6(+group,-group)).
:- modeb(1,polar(+group,-polarval)).
:- modeb(1,polar(+group,#polarval)).
:- modeb(1,size(+group,-sizeval)).
:- modeb(1,size(+group,#sizeval)).
:- modeb(1,flex(+group,-flexval)).
:- modeb(1,flex(+group,#flexval)).
:- modeb(1,h_doner(+group,-hdonerval)).
:- modeb(1,h_doner(+group,#hdonerval)).
:- modeb(1,h_acceptor(+group,-hacceptorval)).
:- modeb(1,h_acceptor(+group,#hacceptorval)).
:- modeb(1,pi_doner(+group,-pidonerval)).
:- modeb(1,pi_doner(+group,#pidonerval)).
:- modeb(1,pi_acceptor(+group,-piacceptorval)).
:- modeb(1,pi_acceptor(+group,#piacceptorval)).
:- modeb(1,polarisable(+group,-polarival)).
:- modeb(1,polarisable(+group,#polarival)).
:- modeb(1,sigma(+group,-sigmaval)).
:- modeb(1,sigma(+group,#sigmaval)).
:- modeb(1,n_val(+group,-number)).
:- modeb(1,n_val(+group,#number)).
%%%%%%%%%%%:- modeb(1,subs(+,-)).
%%%%%%%%%%%:- modeb(1,group(+,-)).

:- modeb(1,great_polar(+polarval,+polarval)).
:- modeb(1,great_polar(+polarval,#polarval)).
:- modeb(1,great_size(+sizeval,+sizeval)).
:- modeb(1,great_size(+sizeval,#sizeval)).
:- modeb(1,great_flex(+flexval,+flexval)).
:- modeb(1,great_flex(+flexval,#flexval)).
:- modeb(1,great_h_don(+hdonerval,+hdonerval)).
:- modeb(1,great_h_don(+hdonerval,#hdonerval)).
:- modeb(1,great_h_acc(+hacceptorval,+hacceptorval)).
:- modeb(1,great_h_acc(+hacceptorval,#hacceptorval)).
:- modeb(1,great_pi_don(+pidonerval,+pidonerval)).
:- modeb(1,great_pi_don(+pidonerval,#pidonerval)).
:- modeb(1,great_pi_acc(+piacceptorval,+piacceptorval)).
:- modeb(1,great_pi_acc(+piacceptorval,#piacceptorval)).
:- modeb(1,great_polari(+polarival,+polarival)).
:- modeb(1,great_polari(+polarival,#polarival)).
:- modeb(1,great_sigma(+sigmaval,+sigmaval)).
:- modeb(1,great_sigma(+sigmaval,#sigmaval)).
:- modeb(1,gt(+number,+number)).
:- modeb(1,gt(+number,#number)).
...
:- discontiguous aleph:r_subst_1/2.
:- discontiguous aleph:r_subst_2/2.
:- discontiguous aleph:ring_subst_2/2.
:- discontiguous aleph:ring_subst_3/2.
:- discontiguous aleph:ring_subst_4/2.
:- discontiguous aleph:r_subst_3/2.
...
great_polar(X, Y) :- gt(X, Y).
great_size(X, Y) :- gt(X, Y).
great_flex(X, Y) :- gt(X, Y).
great_h_don(X, Y) :- gt(X, Y).
great_h_acc(X, Y) :- gt(X, Y).
great_pi_don(X, Y) :- gt(X, Y).
great_pi_acc(X, Y) :- gt(X, Y).
great_polari(X, Y) :- gt(X, Y).
great_sigma(X, Y) :- gt(X, Y).
